...
const JOBS_DATA = [
  ...
  {
    id: 301,
    title: "Japanese Account Manager (EU HQ)",
...

  {
    ...
    type: "Full-time",
    tags: ["Japanese", "Client Success", "High Commission", "Relocation", "13th Month Salary"],
    posted_at: "1d ago",
    featured: true,
    ai_verified: true,
    status: "priority",
  ...
  {
    id: 704,
    title: "Korean-Japanese Interpreter (Tech)",
    ...
    salary_max: 60000,
    currency: "EUR",
    location: "Warsaw, Poland (EU Base)",
    type: "Full-time",
    tags: ["Korean", "Japanese", "Interpretation", "Tech", "Trilingual"],
    posted_at: "5d ago",
    featured: true,
    ai_verified: true,
    status: "priority",
