...
import { ArrowLeft, CheckCircle2, MapPin, Briefcase, Shield } from 'lucide-react';
import { SEOLandingPage } from '@/config/seo-landing-pages';
...
// JOB FILTERING LOGIC
// ========================================
function filterJobsByConfig(config: SEOLandingPage) {
...
// ========================================
function HeroSection({ config, jobCount }: { config: SEOLandingPage; jobCount: number }) {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-8 mb-8">
          <div className="text-center">
            <div className="text-3xl font-bold text-blue-600 mb-1">{jobCount}개</div>
...
// ========================================
function JobsSection({ config, jobs }: { config: SEOLandingPage; jobs: typeof JOBS_DATA }) {
  return (
    <div id="jobs" className="max-w-6xl mx-auto px-4 py-12">
      <div className="mb-8">
        ...
        <p className="text-slate-600">
          총 {jobs.length}개의 포지션이 당신을 기다리고 있습니다
        </p>
      </div>
...
// MAIN VIEW COMPONENT
// ========================================
export default function SEOLandingPageView({ config }: { config: SEOLandingPage }) {
  // Filter jobs based on config
  const filteredJobs = useMemo(() => filterJobsByConfig(config), [config]);
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* Hero Section */}
      <HeroSection config={config} jobCount={filteredJobs.length} />

      {/* Benefits Section */}
      <BenefitsSection />

      {/* Jobs Section */}
      <JobsSection config={config} jobs={filteredJobs} />
